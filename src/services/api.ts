...
export const projectService = {
  ...
  async updateProject(id: string, name?: string, description?: string, genre?: string): Promise<Project> {
...
export const aiGeneratorService = {
  // AI 生成角色
  async generateCharacter(projectId: string, options?: { type?: string; description?: string }): Promise<GeneratedCharacter> {
  ...
  // AI 生成情节点
  async generatePlotPoints(projectId: string, context?: string, direction?: string): Promise<GeneratedPlotPoint[]> {
